		...
		<form action="#" method="POST">
			<div class="form-group">
  			...
  			<div class="form-group">
    			...
    			<input type="name" class="form-control" id="InputDept" name="department" value="<?php echo "{$info['DEPARTMENT']}"; ?>">
  			</div>
  			<div class="form-group">
    			<label for="InputBatch1">Batch</label>
    			<input type="name" class="form-control" id="InputBatch" name="batch" value="<?php echo "{$info['BATCH']}"; ?>">
  			</div>
  			<div class="form-group">
    			<label for="exampleInputRoll1">Roll</label>
    			<input type="number" class="form-control" id="exampleInputRoll1" name="roll" value="<?php echo "{$info['ROLL']}"; ?>">
  			</div>
  			<div class="form-group">
